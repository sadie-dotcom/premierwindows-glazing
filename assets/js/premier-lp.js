/* ==========================================================================
   ...
   Handles: 2-step quote form + validation, telephone-click tracking,
...
(function(){
  ...
  var TRACKING = {
    ...
    SUCCESS_URL      : '/thank-you',         /* TODO: confirm thank-you page exists */
  ...
  /* No form on the page? Nothing else to wire up. */
  if (!form) return;
  ...
  next.addEventListener('click', function(){
    ...
    ga4('quote_step_1_complete', {
      replacing: form.replacing.value,
      qty: form.qty.value
    });
